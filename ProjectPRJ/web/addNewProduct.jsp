...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/addNewProduct.css">
            ...
            <div class="header">
                ...
                <div class="wrap">
                    <form action="search" class="search" method="post">
                        ...
                        <input name = "lowestPrice" type = "text" >
                        <input name = "highestPrice" type = "text">
                ...
                <div class="lors">   
                    <c:choose>
                        <c:when test="${sessionScope.customer != null}">
                            ...
                            <form action="addNewProduct" method="post" id="form_load">
                                <div class="addProduct">
                                    ...
                                    <div class = "right">
                                        <input type="text"  id="productName" name="Name" required="" value="" ><br/>
                                        <input type="number"  id="price" name="Price"  required="" value = ""><br/>
                                        <input type="text" id="image" name="Image" required="" value=""><br/>
                                        <input type="text"  id="description" name="Description"  required="" value = ""><br/>
                                        <input type="number"  id="quantity" name="Quantity" required="" value = ""><br/>                       
                                        <input type="number"  id="categoryID" name="CategoryID" required="" value=""><br/>
                                        <input type="submit" value="Add Product" name="btnChangeProfile">
                                    </div>
                                </div>
                            </form>
                            <div class = "footer">
