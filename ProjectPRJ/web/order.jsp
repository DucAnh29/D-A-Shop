...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div>
                <c:forEach items="${sessionScope.customer.getOrder()}" var="o">
                    <div class="purchaseHistory">
                        <div><a href="orderDetail?OrderID=${o.getOrderID()}">OrderID: ${o.getOrderID()}</a></div><br/>
                        <div>Date: ${o.getOrderDate()}</div><br/>
                    </div>
                </c:forEach>    
            </div>
