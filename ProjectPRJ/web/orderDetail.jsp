...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/orderDetail.css">
        ...
        <div class="container">
            ...
            <div class="lors">   
                <c:choose>
                    <c:when test="${sessionScope.customer !=  null}">
                        <a href="manageListProduct" style="${sessionScope.customer.getRole() == "admin" ? "" : "display: none"}"></a>
            ...
            <c:choose>
                <c:when test="${requestScope.isCartEmpty}">
                    ...
                    <span class="resultCart">Don't have Order</span>
                </c:when>
                <c:otherwise>
                    <div class="orderCart">
                        <div class = "orderDetailHistory">
                            <table>
                                ...
                                <c:forEach items="${requestScope.orderDetailList}" var="o">                
                                    <tr>    
                                        <td><img src="${pageContext.request.contextPath}/${o.getProduct().getImage()}" style="width: 70px"></td>
