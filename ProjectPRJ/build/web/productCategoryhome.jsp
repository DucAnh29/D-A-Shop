                ...
                <div class="lors">   
                    <c:choose>
                        <c:when test="${sessionScope.customer !=  null}">
                            ...
                            <div class = "menuCategory">
                                <ul>
                                    <c:forEach items="${requestScope.listCategory}" var="o">
                                        <c:choose>
                                            <c:when test='${requestScope.category.getName().equals(o.getName())}'>
                                                <li ><a style="color: orange;" href="category?CategoryID=${o.getCategoryID()}">${o.getName()}</a></li>
                                                </c:when>
                                                <c:otherwise>
                            ...
                            <div class = "title">${requestScope.category.getName()} SHOES</div>    
