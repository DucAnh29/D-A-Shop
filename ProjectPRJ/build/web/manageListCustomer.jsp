                    ...
                    <c:choose>
                        <c:when test="${sessionScope.customer != null}">
                            ...
                            <div class="container">
                                ...
                                <form action="manageListCustomer" class="manageProduct" method="post">
                                    <table border="1" width="5"  style="width:89%">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listCustomer}" var="o">
                                                <tr>
                                                    ...
                                                    <td>${o.getPhone()}</td>
                                                    <td>${o.getAddress()}</td>
                                                    <td>${o.convertToDot()}</td>
                                                    <td>${o.getRole()}</td>
                                                    <td><a href="manageCustomerDetail?CustomerID=${o.getCustomerID()}" class="fa fa-edit"></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
